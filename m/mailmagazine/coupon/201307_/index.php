...
if (preg_match('/^J-PHONE/', $agent) or
	...
	// モバイルページへジャンプ
	if($i == 0){
    header('Location: http://www.cinemasunshine.co.jp/mailmagazine/coupon/201307/');
	exit();
	}
?>
...
<img src="images/waribiki_img_1_m.gif" alt="一般､大学生､高校生 300円引き　小･中学生､幼児 200円引き"/>
</center>
<br><img src="images/spacer.gif" height="10"><br>
<font size="1">
<p>
...
※割引券1枚で2名様まで有効です。
他の割引ｻｰﾋﾞｽとの併用はできません。
また、特別興行、IMAXﾃﾞｼﾞﾀﾙｼｱﾀｰでの上映作品にはご利用頂けません。
<br/>※高校生は「高校生映画鑑賞応援ﾌﾟﾗｲｽ（1000円）」実施中のため対象外となります。
<br/>※期間中何回でもご利用頂けます。
<br/>※ｲﾝﾀｰﾈｯﾄ購入ではご利用頂けません。
</span>
</p>
</font>
<br><img src="images/spacer.gif" height="10"><br>
