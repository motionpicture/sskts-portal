...
if (preg_match('/^J-PHONE/', $agent) or
	...
	// モバイルページへジャンプ
	if($i == 0){
    header('Location: http://www.cinemasunshine.co.jp/mailmagazine/coupon/201211/');
	exit();
	}
?>
...
※割引券1枚で2名様まで有効です。
他の割引ｻｰﾋﾞｽとの併用はできません。
また、特別興行、IMAXデジタルシアターでの上映作品、沼津の高校生料金には
ご利用頂けません。
<br/>※期間中何回でもご利用頂けます。
<br/>※インターネット購入ではご利用頂けません。
<br/>※松戸のみ､幼児は100円引きとなります｡
</span>
</p>
</font>
<br><img src="images/spacer.gif" height="10"><br>
