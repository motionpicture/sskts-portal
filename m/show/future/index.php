...
foreach ($cinemaList as $value) {
	if (!empty($value["name"])) {
		$html .= "・<a href=\"../detail/?i={$value["id"]}&amp;mode=future\"><span style=\"font-size:x-small;color:#7c6854;\">{$value["name"]}</span></a><br />
