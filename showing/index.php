				...
				<div id="contents" class="clearfix">
					...
					<div id="mainColumn" class="clearfix">
						...
						<div class="leftColumn">
							<h2 class="headlineImg showListHeadLine"><img src="../images/common/headline_Show.png"  alt="上映中作品" ></h2>
							...
							<div class="SearchListArea">
								<div class="SearchLisBox clearfix">
								...
								if (!empty($_GET['theaterSelect'])){
									$showings = getNowRoadShow($_GET['theaterSelect']);
								} else {
