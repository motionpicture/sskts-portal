							...
							<div class="MainArea">
								...
								<div class="whiteCanvas clearfix">
									...
									<table class="menuTable">
										...
										<tr>
											<td class="menuName"><p>コーラ・コーラゼロ・ジンジャーエール・ファンタレモン・<br />ファンタメロン・カルピス・アイスティー・ウーロン茶<br />スプライト</p></td>
											<td class="menuprice" >
												<p>
													Sサイズ&nbsp;&nbsp;250円<br />
													Mサイズ&nbsp;&nbsp;350円<br />
...
　　　　　　　　　　　　　　　　　　　　　　　<tr class="line">
									...
									<table class="menuTable">
                                        ...
                                        <tr>
			 								<td class="menuName">
												<p class="Name">ディッピンドッツ・アイスクリーム</p>
											</td>
										</tr>
                                        <tr>
											<td class="menuName">
												<p class="optionText">レインボー・ストロベリー チーズケーキ</p>
											</td>
...
　　　　　　　　　　　　　　　　　　　　　　　<tr>
										...
										<tr>
											<td class="menuName">
												<p class="optionText">ペアセット(ポップコーンL＋ドリンクM×2)</p>
											</td>
											<td class="menuprice" ><p>1100円</p></td>
										</tr>
										<tr class="line">
											<td colspan="2" valign="middle"><p><img src="../../../images/common/img_line.gif"></p></td>
										</tr>
										...
										<tr>
											...
											<td class="menuprice" ><p>1050円</p></td>
										</tr>
										<tr>
											<td class="menuName">
												<p class="optionText">ペアセット(ポップコーンL＋ドリンクM×2)</p>
											</td>
											<td class="menuprice" ><p>1300円</p></td>
										</tr>
										<tr class="line">
											<td colspan="2" valign="middle"><p><img src="../../../images/common/img_line.gif"></p></td>
										</tr>
										<tr>
											<td class="menuName">
												<p class="Name">ポップコーン塩・キャラメル</p>
											</td>
											<td class="menuprice" ></td>
										</tr>
										<tr>
											<td class="menuName">
												<p class="optionText">LLセット(ポップコーンハーフL ＋ドリンクL)</p>
											</td>
											<td class="menuprice" ><p>950円</p></td>
										</tr>
										<tr>
											<td class="menuName">
												<p class="optionText">ペアセット(ポップコーンハーフL＋ドリンクM×2)</p>
											</td>
