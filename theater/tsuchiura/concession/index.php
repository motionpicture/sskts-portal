						...
						<div class="leftColumn">
							<div class="MainArea">
								...
								<div class="whiteCanvas clearfix">
                                    ...
                                    <!--
                                    <h3 class="lightBlueTitle">ペットボトル</h3>
									<table class="menuTable">
										<tr class="line">
											<td colspan="2" valign="middle"><p><img src="../../../images/common/img_line.gif"></span></p></td>
										</tr>
										...
										<tr>
											<td class="menuName"><p>いろはす</p></td>
											<td class="menuprice" ><p>200円</p></td>
										</tr>
                                        ...
                                        <tr>
											<td class="menuName"><p>グラソー　ビタミンウォーター</p></td>
...
-->
  ...
  <tr class="line">
                                  ...
                                  <tr>
                                        ...
                                        <tr>
											<td class="menuName">
												<p class="Name">ソフローズン</p>
											</td>
										</tr>

										<tr>
											<td class="menuName">
												<p class="optionText">グレープ・メロン</p>
											</td>
											<td class="menuprice" ><p>300円</p></td>
										</tr>
								  ...
								  <tr class="line">
									...
									<table class="menuTable">
                                        ...
                                        <tr>
											<td class="menuName">
												<p class="Name">プレツェル</p>
											</td>
										</tr>

										<tr>
											<td class="menuName">
												<p class="optionText">クリームチーズ</p>
											</td>
											<td class="menuprice" ><p>350円</p></td>
										</tr>
										<tr class="line">
                                        ...
                                        <tr>
											<td class="menuName">
												<p class="Name">キャラメルクリスプポップコーン</p>
											</td>
