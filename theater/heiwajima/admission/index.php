						...
						<div class="leftColumn">
							<div class="MainArea">
								...
								<div class="whiteCanvas clearfix">
									...
									<h3 class="lightBlueTitle">アメイジング・サウンドシアタープレミアム料金</h3>
									<table class="priceTable">
										<tr class="line">
											<td colspan="3" valign="middle"><p><img src="../../../images/common/img_line.gif"></p></td>
										</tr>
										...
										<tr>
											<td class="priceSubject"><p>アメイジング・サウンドシアタープレミアム料金</p></td>
											<td class="priceNotes" >
												<p>
													2D作品の場合<br />
												...
												<p>
													...
													レイトショーの場合<br /></p>
													<p>(例)〈レイトショー1,300円〉+〈アメイジング・サウンドシアタープレミアム料金200円〉＝1,500円<br /><br />
												</p>
												<!--<p>※imm 3D sound シアターで上映の作品では、ムビチケはご利用いただけません。</p>-->
											</td>
									...
									<table class="priceTable">
										...
										<tr>
											...
											<td class="priceNotes" >
												...
												<p>※身長100cm未満の方、妊娠中の方、ご高齢の方、心臓・背中・腰・首などに障害のある方、特別な疾病のある方、乗り物酔いしやすい方、その他体調に不安のある方などは、４DX®をご利用いただけません。また、10歳以下のお子様は保護者の方と一緒にご鑑賞ください。</p>
											</td>
