							...
							<div class="MainArea">
								...
								<div class="whiteCanvas clearfix">
									...
									<table class="menuTable">
										...
										<tr>
											<td class="menuName"><p>ペプシ・ペプシネックス・ジンジャエール・なっちゃんオレンジ・メロンソーダ・ホワイトウォーター・アイスティー・ウーロン茶</p></td>
											<td class="menuprice" >
												<p>
													Ｓサイズ&nbsp;&nbsp;250円<br />
													Ｍサイズ&nbsp;&nbsp;350円<br />
									...
									<table class="menuTable">
										...
										<tr>
											<td class="menuName">
												<p class="optionText">ミネラルウォーター</p>
											</td>
											<td class="menuprice" >210円</td>
										</tr>
									...
									<table class="menuTable">
                                        ...
                                        <tr>
											<td class="menuName">
												<p class="Name">タピオカミルクティー </p>
											</td>
											<td class="menuprice" >400円</td>
										</tr>
										...
										<tr>
											<td class="menuName">
												<p class="Name">フラペリッチ</p>
											</td>
										</tr>

										<tr>
											<td class="menuName">
												<p class="optionText">キャラメル</p>
											</td>
											<td class="menuprice" >380円</td>
										</tr>
									...
									<table class="menuTable">
										...
										<tr>
											<td class="menuName">
												<p class="Name">ソフトクリーム</p>
											</td>
										</tr>
										<tr>
											<td class="menuName">
												<p class="optionText">バニラ・クッキークリーム</p>
											</td>
											<td class="menuprice" ><p>350円</p></td>
										</tr>
									...
									<table class="menuTable end">
                                        ...
                                        <tr>
											<td class="menuName"><p>ポップコーンハーフ</p></td>
										</tr>
