	...
	<div class="basebox2_ptrl">
		...
		<!--ここから-->		
			...
			<div class="about_mvtk1">
				<h3>ムビチケについて</h3>
				<div>
					<img class="mvtk_pg_logo" src="../../sp/images/mvtk/mvtk_SP_logo.gif" width="478" height="106" alt="ムビチケロゴ">
			...
			<div class="about_mvtk2">
				...
				<div class="step">
					...
					<img src="../../sp/images/mvtk/mvtk_sp_1.gif" width="630" height="377" alt="">
				</div>
				
				<div class="step">
					<p class="step_title">STEP <span>2</span></p>
					<p class="content_text">鑑賞したい座席を選択し、利用規約の同意にチェックし「次へ」ボタンを押してください。</p>
					<img src="../../sp/images/mvtk/mvtk_sp_2.gif" width="630" height="377" alt="">
				</div>
				...
				<div class="step">
					...
					<img src="../../sp/images/mvtk/mvtk_sp_3.gif" width="630" height="377" alt="">
				</div>
				...
				<div class="step">
					...
					<img src="../../sp/images/mvtk/mvtk_sp_4.gif" width="630" height="377" alt="">
				</div>

				<div class="step">
					<p class="step_title">STEP <span>5</span></p>
					<p class="content_text">認証完了後、ムビチケ券の内容確認が表示されるので、問題なければ「券種選択へ戻る」ボタンを押してください。</p>
					<img src="../../sp/images/mvtk/mvtk_sp_5.gif" width="630" height="377" alt="">
				</div>
				...
				<div class="step">
					...
					<img src="../../sp/images/mvtk/mvtk_sp_6.gif" width="630" height="377" alt="">
				</div>

				<div class="step">
					<p class="step_title">STEP <span>7</span></p>
					<p class="content_text">後の手順は、画面に沿って手続きを進めていただきムビチケ券を利用してのオンラインチケット購入は完了となります。</p>
					<img src="../../sp/images/mvtk/mvtk_sp_7.gif" width="630" height="377" alt="">
				</div>
			</div>
