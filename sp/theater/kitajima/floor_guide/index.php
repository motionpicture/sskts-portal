			...
			<table cellpadding="0" cellspacing="0" class="theater_u">
				<tbody>
					...
					<tr>
						...
						<td class="admission_tl_name">4DX<sup>&reg;</sup>シアター<span style="color:red;font-size:0.8em;">&nbsp;[7/28(金)より]</span></td>
					</tr>
					<tr>
		...
		<div class="table_wrapper regulation02">
			<table cellpadding="0" cellspacing="0" class="theater_u">
				<tbody>
					...
					<tr>
						<td class="admission_icon" rowspan="2"><a target="_blank" href="https://www.facebook.com/sunshinekitajima"><img src="../../../images/theater/icon_facebook.gif" width="50" alt="facebook"></a></td>
					...
					<tr>
						<td class="admission_icon" rowspan="2"><a target="_blank" href="https://twitter.com/cs_kitajima"><img src="../../../images/theater/icon_twitter.gif" width="50" alt="twitter"></a></td>
