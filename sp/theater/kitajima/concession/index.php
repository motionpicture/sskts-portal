...
<div class="basebox2_ptrl">
	...
	<div class="table_wrapper regulation02">
		<table cellpadding="0" cellspacing="0" class="theater_u">
			<tbody>
				<tr>
					<td class="admission_tl">コカコーラ・コカコーラゼロ・ジンジャエール・メロンソーダ・ミニッツメイドオレンジ・カルピス・アールグレイアイスティー・煌ウーロン茶</td>
	...
	<div class="table_wrapper regulation02">
		<table cellpadding="0" cellspacing="0" class="theater_u">
			<tbody>
                ...
                <tr>
					<td class="admission_tl">神戸ドーナツ<br />
						<span class="notice">プレーン・チョコ・シナモン・キャラメル</span></td>
		...
		<table cellpadding="0" cellspacing="0" class="theater_u">
			<tbody>
				<tr>
                    ...
                    <tr>
						<td colspan="2" class="admission_tl regulation04">塩・キャラメル</td>
					</tr>
                    <tr>
