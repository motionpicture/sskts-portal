			...
			<table cellpadding="0" cellspacing="0" class="access_u">
				<tbody>
					...
					<tr>
						...
						<td class="access_tr">愛媛県今治市東門町5-13-1　フジグラン今治2F </td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="access_tr"><p>24時間上映案内<br />
							<span class="stand_out">0898-33-8882</span><br />
					...
					<tr>
						...
						<td class="access_tr">無料駐車場　1,200台</td>
					</tr>
					<tr>
						<td colspan="2" class="table_line_02"></td>
					</tr>
					<tr>
						<td colspan="2" class="access_to">JR今治駅より「瀬戸内バス営業所」行バスにて終点下車、徒歩10分。 <br>
							県道38号線を今治城方面へ。今治城の案内のある交差点を左折し瀬戸内バス営業所先。 <br>
						県道38号線を直進。喜田村のY字交差点を産業道路方面へ。今治城の交差点を右折し、瀬戸内バス営業所先。</td>
					</tr>
					<tr>
						<td colspan="2" class="table_line_02"></td>
					</tr>
