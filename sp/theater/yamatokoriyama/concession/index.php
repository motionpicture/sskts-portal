	...
	<div class="basebox2_ptrl">
		...
		<div class="table_wrapper regulation02">
			<table cellpadding="0" cellspacing="0" class="theater_u">
				<tbody>
					<tr>
						<td class="admission_tl">ペプシコーラ・ペプシネックス・セブンアップ・ニチレイアセロラマイルド・ポップメロンソーダ・ホワイトウォーター・リプトンアイスティー・ウーロン茶・まろやか緑茶・オレンジ100</td>
		...
		<table cellpadding="0" cellspacing="0" class="theater_u">
			<tbody>
				...
				<tr>
					<td class="admission_tl">アメリカンドック</td>
					<td class="admission_tr">310円</td>
				</tr>
