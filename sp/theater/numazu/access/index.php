			...
			<table cellpadding="0" cellspacing="0" class="access_u">
				<tbody>
					...
					<tr>
						...
						<td class="access_tr">静岡県沼津市大手町1-1-5 BiVi沼津4F</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="access_tr"><p>24時間上映案内<br />
							<span class="stand_out">055-926-7712</span><br />
					...
					<tr>
						...
						<td class="access_tr">「BiVi沼津内駐車場」を3時間無料でご利用いただけます。 <br>
						3時間無料サービス券を発行いたしますので、チケット購入時に駐車券を係員までご提示ください。</td>
					</tr>
					<tr>
						<td colspan="2" class="table_line_02"></td>
					</tr>
					<tr>
						<td colspan="2" class="access_to">JR東海道線・御殿場線、沼津駅北口ロータリー右手「ＢｉＶｉ沼津」4F<br>
							国道1号線、江原公園交差点を南に約1・7Km、JRガード手前の信号を左折してください。 <br>
						伊豆方面よりお越しの方は、国道414号線を北上し、狩野川を渡り、東海道線沼津駅東側ガードをくぐり、1つ目の信号を左折</td>
					</tr>
					<tr>
						<td colspan="2" class="table_line_02"></td>
					</tr>
