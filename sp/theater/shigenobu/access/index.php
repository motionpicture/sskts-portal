...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../../../css/access.css?20170713">
</head>
<body>
	<?php getSmartHeader(); ?>
	<?php getSmartPankuzu(); ?>
			...
			<table cellpadding="0" cellspacing="0" class="access_u">
				<tbody>
					...
					<tr>
						...
						<td class="access_tr">愛媛県東温市野田3-1-13 フジグラン重信3F</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="access_tr"><p>24時間上映案内<br />
							<span class="stand_out">089-990-1513</span><br />
					...
					<tr>
						...
						<td class="access_tr">無料駐車場　2,111台</td>
					</tr>
					<tr>
						<td colspan="2" class="table_line_02"></td>
					</tr>
					<tr>
						<td colspan="2" class="access_to">松山市駅より、伊予鉄バスと瀬戸内バスが運行している松山⇔新居浜特急線がフジグラン重信SC前（国道11号線バイパス沿い）に停車 <br>
							伊予鉄道横河原線梅本駅より徒歩15分 <br>
						松山市内より、国道11号線を川内方面へ、東温市に入ってすぐ左側</td>
					</tr>
					<tr>
						<td colspan="2" class="table_line_02"></td>
					</tr>
