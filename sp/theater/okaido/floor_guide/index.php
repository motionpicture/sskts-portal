			...
			<table cellpadding="0" cellspacing="0" class="theater_u">
				<tbody>
					...
					<tr>
						...
						<td class="admission_tc">110</td>
						<td class="admission_tc">2</td>
						<td class="admission_tc">デジタル6ch</td>
						<td class="admission_tc">W4.3m<br>
H1.8m</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="admission_tc">42</td>
						<td class="admission_tc">2</td>
						<td class="admission_tc">デジタル6ch</td>
						<td class="admission_tc">W4.6m<br>
						H2.5m</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="admission_tc">88</td>
						<td class="admission_tc">2</td>
						<td class="admission_tc">デジタル6ch</td>
						<td class="admission_tc">W6.2m<br>
						H2.7m</td>
					</tr>
				</tbody>
			</table>
		...
		<div class="table_wrapper regulation02">
			<table cellpadding="0" cellspacing="0" class="theater_u">
				<tbody>
					...
					<tr>
						<td class="admission_icon" rowspan="2"><a target="_blank" href="http://www.facebook.com/sunshineehime"><img src="../../../images/theater/icon_facebook.gif" width="50" alt="facebook"></a></td>
					...
					<tr>
						<td class="admission_icon" rowspan="2"><a target="_blank" href="http://twitter.com/cs_ehime"><img src="../../../images/theater/icon_twitter.gif" width="50" alt="twitter"></a></td>
