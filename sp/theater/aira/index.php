				...
				foreach ($movie->screen as $screen) {
					...
					foreach ($screen->time as $time) {
						...
						if($time->available==6) {
							...
							echo '<td class="pfm_btn"><img src="../../images/theater/btn_buyPtn1.gif" width="100%" alt="窓口"></td>';
						}else if ($time->available==5) {
							echo '<td class="pfm_btn"><img src="../../images/theater/btn_buyPtn5.gif" width="100%" alt="満席"></td>';
						}else {
							echo '<td class="pfm_btn"><a href="'.$time->url.'"><img src="../../images/theater/btn_buyPtn'.$time->available.'.gif" width="100%" alt="購入"></a></td>';
						}
