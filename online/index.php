							...
							<div class="whiteCanvas">
								...
								<div class="admission">
									...
									<div class="admission-inner01">
										...
										<div>
											...
											<div>
												<p>
													手順 1<br>
													購入完了メールに記載されているリンクもしくは、劇場ページにあるチケット照会バナーを押して
													チケット照会ページにアクセス。
												</p>
											</div>
											<div>
												<p>
													手順 2<br>
													チケット情報照会画面にて予約番号と購入時に入力した電話番号を入力してチケット情報ページにアクセス。
													掲載されているQRコードをスマートフォンの画面に表示してください。
												</p>
											</div>
											<div>
												<p>
													手順 3<br>
													スマートフォンの画面で表示したQRコードを入場口スタッフにご提示していただくとご入場いただけます。
												</p>
											</div>
										</div>
										<div>
											<p>
												オススメ<br>
												入場用QRコードは鑑賞日時の24時間前から表示されるため、事前にチケット情報ページを「ホーム画面に
												追加」していただくとスムーズにQRコードがご提示できるためオススメです。
											</p>
										</div>
									...
									<div class="admission-inner02">
										...
										<div>
											...
											<div>
												<p>
													手順 2<br>
													チケット情報照会画面にて予約番号と購入時に入力した電話番号を入力し、チケット情報ページにアクセス。
													掲載されているQRコードをご自宅のプリンターで印刷しご持参ください。
												</p>
											</div>
										</div>
										<div>
											<p>
												オススメ<br>
												入場用QRコードは鑑賞日時の24時間前から表示されるため、事前にチケット情報ページを印刷していただ
												くとスムーズに入場していただけます。
											</p>
										</div>
											<p>
											...
											<div>
												<p>
													ご自宅で印刷したQRコードを忘れずにご持参ください。<br>
													※劇場内に設置されている発券機からもチケットを発券していただけます。
												</p>
											</div>
											<p>
										...
										<div>
											...
											<div>
												<p>
													ご自宅で印刷していただいたQRコード、または劇場の発券機から発券したチケットを入場時間になりました
													ら入場口スタッフにご提示していただきますとご入場いただけます。	
												</p>
											</div>	
										</div>
										<div>
									...
									<div class="admission-inner03">
										...
										<div>
											<p>
												4. 発券したチケットを入場口スタッフにご提示してご入場ください
											</p>
											<div>
												<p>
