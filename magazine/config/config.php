...
$database_name = "cam_mailmagazine";

# who do we log in as?
$database_user = "root";

# and what password do we use
$database_password = 'osashimi';
...
# requires PHP version > "4.0.5" and "4.3.1+" without safe_mode
 $message_envelope = 'mail_error@cinemasunshine.co.jp';
...
$bounce_mailbox_user = 'mail_error@cinemasunshine.co.jp';
$bounce_mailbox_password = 'mail_e_1er';
...
# PHP mail() command.
define("PHPMAILERHOST",'smtp.cinemasunshine.co.jp');

# if you want to use smtp authentication when sending the email uncomment the following
# two lines and set the username and password to be the correct ones
$phpmailer_smtpuser = 'magazine@cinemasunshine.co.jp';
$phpmailer_smtppassword = '53862089';
