...
print '<title>管理者ログインページ | シネマサンシャインメールマガジン </title>';
print '<script type="text/javascript" src="http://www.cinemasunshine.co.jp/js/wordBreak.js"></script>';
...
print '<p class="leaftitle"><img src="http://www.cinemasunshine.co.jp/magazine/images/login_mark.gif" /> </p>';
