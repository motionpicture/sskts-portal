...
function sendMailPhpMailer ($to,$subject,$message) {
  ...
  $mail->build_message(
      ...
      $destinationemail = mb_convert_encoding ($destinationemail ,"iso-2022-jp","utf-8" );
      $fromname = mb_convert_encoding ($fromname ,"iso-2022-jp","utf-8" );
      $fromemail = mb_convert_encoding ($fromemail ,"iso-2022-jp","utf-8" );
...
function system_messageHeaders($useremail = "") {
  ...
  $additional_headers .= "X-Mailer: CinemaSunshine\n";
