...
txt+='<div style="position:absolute; top:1px; left:1px; width:'+(barwidth-2)+'px; height:'+(barheight-2)+'px; background-color:'+unloadedcolor+'; font-size:12px; color:black; text-align:center;">処理中です。絶対にほかの操作をしないでください。</div>';
