<div id="panku">ピックアップバナー ＞ 検索</div>

<?php echo $this->Form->create('Pick', array('type'=>'file'));?>
<?php echo $this->Form->input('id'); ?>
<TABLE WIDTH="100%" ALIGN="CENTER" BORDER="1" CELLSPACING="0"
	CELLPADDING="0" FRAME="BOX">
	<TR>
		<TH CLASS="tableHeader" WIDTH="10%" HEIGHT="25" ALIGN="RIGHT" NOWRAP><FONT
			CLASS="tableStr">ピックアップバナー ID</FONT></TH>
	...
	<TR>
		...
		<?php if ($this->data['Pick']['pic_path'] != "") { ?>
		<?php echo $this->data['Pick']['pic_path'] ?><br /> <img
			src="/theaters_image/pick/<?php echo $this->data['Pick']['pic_path'] ?>" /><br />
								<?php } ?>
