<div id="panku">Now Showing＞ 編集</div>


<?php echo $this->Form->create('NowShowing');?>
	...
	<TR>
		<TD>
			...
			<TABLE WIDTH="100%" ALIGN="CENTER" BORDER="1" CELLSPACING="0"
				...
				<TR>
					<TH CLASS="tableHeader" ALIGN="RIGHT" NOWRAP><FONT CLASS="tableStr">NOW SHOWING対象作品１</FONT>
					</TH>
					<TD CLASS="tableElement">
					<?php echo $this->Form->select('movie_code1',$movie_code, null, array('empty' => false)); ?>
				</TR>
				<TR>
					<TH CLASS="tableHeader" ALIGN="RIGHT" NOWRAP><FONT CLASS="tableStr">NOW SHOWING対象作品２</FONT>
					</TH>
					<TD CLASS="tableElement">
