<div id="panku">上映作品 ＞ 登録</div>
<TABLE WIDTH="100%" ALIGN="CENTER">
	<?php echo $this->Form->create('Roadshow');?>
	<TR><TD>
		<TABLE WIDTH="100%" ALIGN="CENTER" BORDER="1" CELLSPACING="0" CELLPADDING="1" FRAME="BOX">
			<tr>
				<TH CLASS="tableHeader" COLSPAN="2" WIDTH="150" HEIGHT="30" ALIGN="RIGHT" NOWRAP><FONT CLASS="tableStr">作品</FONT></TH>
				<td CLASS="tableElement">
					<?php echo $this->Form->select('movie_code',$movies, null, array('empty' => false)); ?>
				</td>
			</tr>
			<tr>
				<TH CLASS="tableHeader" WIDTH="1%" rowspan="3" ALIGN="CENTER" NOWRAP><FONT CLASS="tableStr">上映期間</FONT></TH>
				<TH CLASS="tableHeader" WIDTH="1%" HEIGHT="30" ALIGN="RIGHT" NOWRAP><FONT CLASS="tableStr">期間</FONT></TH>
				<td CLASS="tableElement">
			...
			<tr>
				<TH CLASS="tableHeader" WIDTH="1%" HEIGHT="30" ALIGN="RIGHT" NOWRAP><FONT CLASS="tableStr">追加表示用</FONT></TH>
				<td CLASS="tableElement"><?php echo $this->Form->textarea('tuika',array('label' => false, 'error'=>false,  'div'=>false, 'error'=>false, 'cols'=>'72','rows'=>'10')); ?>　<span class="t10red">（例）池袋ー6/25まで</span></td>
			</tr>
