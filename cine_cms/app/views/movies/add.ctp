	...
	<TR><TD>
		<TABLE WIDTH="100%" ALIGN="CENTER" BORDER="1" CELLSPACING="0" CELLPADDING="2" FRAME="BOX">
			...
			<tr>
				...
				<?php echo $this->Form->textarea('midokoro',array('label' => false, 'error'=>false,  'div'=>false, 'error'=>false, 'cols'=>'80','rows'=>'15'));?>　&nbsp;&nbsp;<A HREF="/kado_cms/tag_sample.html" TARGET="_BLANK">タグサンプル</A>
				</td>
			</tr>
			<tr>
