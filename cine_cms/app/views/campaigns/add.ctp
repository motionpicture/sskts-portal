<div id="panku">キャンペーン ＞ 登録</div>
	...
	<TABLE WIDTH="100%" ALIGN="CENTER" BORDER="1" CELLSPACING="0" CELLPADDING="0" FRAME="BOX">
		<TR>
			<TH CLASS="tableHeader" WIDTH="10%" HEIGHT="25" ALIGN="RIGHT" NOWRAP><FONT CLASS="tableStr">キャンペーン  ID</FONT></TH>
			<TD CLASS="tableElement" COLSPAN="3" NOWRAP VALIGN="CENTER">
				自動連番
			</TD>
		</TR>
		<TR>
		...
		<TR>
			...
			<?php echo $this->Form->input('midasi',array('label' => false, 'error'=>false,  'div'=>false, 'error'=>false,'size'=>30)); ?></TD>
		</TR>

		<TR>
			<TH CLASS="tableHeader" WIDTH="10%" ALIGN="RIGHT" NOWRAP><FONT CLASS="tableStr">外部リンク</FONT></TH>
		...
		<TR>
			<TH CLASS="tableHeader" WIDTH="10%" ALIGN="RIGHT" NOWRAP><FONT CLASS="tableStr">外部リンク(モバイル)</FONT></TH>
