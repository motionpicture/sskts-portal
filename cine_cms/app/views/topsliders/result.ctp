...
<?php foreach ($results as $k => $v) { ?>
		...
		<TR>
			<TD CLASS="tableElement" ALIGN="CENTER" VALIGN="CENTER"><?php echo $html->link($v['Topsliders']['id'],'edit/'.$v['Topsliders']['id'] ); ?></TD>
			<TD CLASS="tableElement" ALIGN="CENTER" VALIGN="CENTER"><?php echo $v['Topsliders']['name'] ?></TD>
		</TR>
		<?php }?>
	</TABLE>
