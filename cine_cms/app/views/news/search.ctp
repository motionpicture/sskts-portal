<div id="panku">News ＞ 検索</div>

<TABLE WIDTH="100%" ALIGN="CENTER" BORDER="1" CELLSPACING="0"
	CELLPADDING="0" FRAME="BOX">


	<?php echo $this->Form->create('News',array('type'=>'GET','action'=>'result'));?>
	<TR>
		...
		<?php echo $this->Form->input('start_date',array('monthNames'=>false, 'dateFormat'=>'YMD','minYear' => date('Y',strtotime("-1 year")),'timeFormat' => 'none',
