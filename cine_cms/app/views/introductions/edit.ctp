...
<TABLE WIDTH="100%" ALIGN="CENTER">
	...
	<TR><TD>
		<TABLE WIDTH="100%" ALIGN="CENTER" BORDER="1" CELLSPACING="0" CELLPADDING="2" FRAME="BOX">
			<tr>
				<TH CLASS="tableHeader" COLSPAN="2" WIDTH="60" ALIGN="RIGHT" NOWRAP><FONT CLASS="tableStr"><SPAN CLASS="t10red">(*)</SPAN>&nbsp;作品名</FONT></TH>
			...
			<tr>
				...
				<?php echo $this->Form->textarea('midokoro1',array('label' => false, 'error'=>false,  'div'=>false, 'error'=>false, 'cols'=>'80','rows'=>'15'));?>　&nbsp;&nbsp;<A HREF="/kado_cms/tag_sample.html" TARGET="_BLANK">タグサンプル</A></td>
			</tr>
			<tr>
				<TH CLASS="tableHeader" COLSPAN="2" WIDTH="150" ALIGN="RIGHT" NOWRAP><FONT CLASS="tableStr">作品紹介（解説・見所）2</FONT></TH>
				<td CLASS="tableElement">
				<SPAN CLASS="t10red">入力可能文字数：全角1500文字</SPAN><br>
				<?php echo $this->Form->textarea('midokoro2',array('label' => false, 'error'=>false,  'div'=>false, 'error'=>false, 'cols'=>'80','rows'=>'15'));?>　&nbsp;&nbsp;<A HREF="/kado_cms/tag_sample.html" TARGET="_BLANK">タグサンプル</A></td>
			</tr>
			<tr>
			...
			<TR>
				...
				<?php if ($this->data['Introduction']['pic_path01'] != "") { ?>
					<?php echo $this->data['Introduction']['pic_path01'] ?><br />
					<img src="/theaters_image/special/<?php echo $this->data['Introduction']['pic_path01'] ?>" /><br />
				<?php } ?>
			...
			<TR>
				...
				<TD CLASS="tableElement" COLSPAN="3" WIDTH="68%" NOWRAP>
				<?php if ($this->data['Introduction']['pic_path02'] != "") { ?>
					<?php echo $this->data['Introduction']['pic_path02'] ?><br />
					<img src="/theaters_image/special/<?php echo $this->data['Introduction']['pic_path02'] ?>" /><br />
				<?php } ?>
			...
			<TR>
				...
				<TD CLASS="tableElement" COLSPAN="3" WIDTH="68%" NOWRAP>
				<?php if ($this->data['Introduction']['pic_bnr'] != "") { ?>
					<?php echo $this->data['Introduction']['pic_bnr'] ?><br />
					<img src="/theaters_image/special/<?php echo $this->data['Introduction']['pic_bnr'] ?>" /><br />
				<?php } ?>
