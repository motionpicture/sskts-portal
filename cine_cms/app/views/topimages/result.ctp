...
<?php echo $this->Form->create('Topimage', array('type'=>'POST','action'=>"result?".http_build_query(Set::remove($this->params['url'],'url'),'','&')));?>
<TABLE WIDTH="800px" ALIGN="CENTER" BORDER="1" CELLSPACING="0" CELLPADDING="0" FRAME="BOX	" style="float:left">
	<TR>
		<TH CLASS="tableHeader" WIDTH="200px" NOWRAP><FONT CLASS="tableStr">劇場</FONT></TH>
		<TH CLASS="tableHeader" WIDTH="600px" NOWRAP><FONT CLASS="tableStr">TOPバナー ID</FONT></TH>
	</TR>
	<?php
