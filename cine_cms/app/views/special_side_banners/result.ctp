<div id="panku">特設サイトサイドバナ－  ＞ 編集</div>

<?php echo $this->Form->create('SpecialSideBanner', array('type'=>'POST','action'=>"result?".http_build_query(Set::remove($this->params['url'],'url'),'','&')));?>
<TABLE WIDTH="800px" ALIGN="CENTER" BORDER="1" CELLSPACING="0"
	...
	<TR>
		...
		<TH CLASS="tableHeader" WIDTH="600px" NOWRAP><FONT CLASS="tableStr">サイドバナー 
				ID</FONT></TH>
	</TR>
...
<TABLE WIDTH="100%" ALIGN="CENTER" BORDER="1" CELLSPACING="0" CELLPADDING="0" FRAME="BOX">
		<TR>
			<TH CLASS="tableHeader" WIDTH="10%" NOWRAP><FONT CLASS="tableStr">サイドバナー ID</FONT></TH>
...
<?php ;foreach ($results as $k => $v) { ?>
		...
		<TR>
			<TD CLASS="tableElement" ALIGN="CENTER" VALIGN="CENTER"><?php echo $html->link($v['special_side_banners']['id'],'edit/'.$v['special_side_banners']['id'] ); ?></TD>
			<TD CLASS="tableElement" ALIGN="CENTER" VALIGN="CENTER"><?php echo $v['special_side_banners']['name'] ?></TD>
		</TR>
		<?php }?>
	</TABLE>
